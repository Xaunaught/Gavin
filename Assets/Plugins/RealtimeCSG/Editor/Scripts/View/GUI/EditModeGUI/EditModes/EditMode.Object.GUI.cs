...
{
	internal sealed partial class EditmodeObjectGUI
	{
		static int SceneViewMeshOverlayHash = "SceneViewMeshOverlay".GetHashCode();

		static Rect lastGuiRect;
		public static Rect GetLastSceneGUIRect(EditModeObject tool)
		{
			return lastGuiRect;
		}

		public static void OnSceneGUI(Rect windowRect, EditModeObject tool)
		{
		...
		public static void OnInspectorGUI(EditorWindow window, float height)
		{
			...
			var tool = EditModeManager.ActiveTool as EditModeObject;
		...
		static void HandleCSGOperations(bool isSceneGUI, EditModeObject tool, FilteredSelection filteredSelection)
		{
		...
		static void OnGUIContents(bool isSceneGUI, EditModeObject tool)
		{
