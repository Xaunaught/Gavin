...
namespace RealtimeCSG
{
	...
	internal delegate bool RayCastMultiDelegate				(CSGModel[]				models,
															 Vector3				rayStart,
															 Vector3				rayEnd,
	...
	internal delegate bool SetBrushLocalToWorldDelegate		(Int32				brushID,
															 ref Matrix4x4		localToWorldSpace);
	...
	#region Meshes
	internal delegate bool ApplyAnyChangesDelegate			();
	...
	internal sealed class NativeMethods
	{
		...
		public SetBrushLocalToWorldDelegate         SetBrushLocalToWorld;
		...
		public ApplyAnyChangesDelegate              ApplyAnyChanges;
		public ModelMeshesNeedUpdateDelegate        ModelMeshesNeedUpdate;
		...
		public RayCastIntoModelDelegate				RayCastIntoModel;
