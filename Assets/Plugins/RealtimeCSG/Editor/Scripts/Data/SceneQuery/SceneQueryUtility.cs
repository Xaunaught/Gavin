	...
	internal static class SceneQueryUtility
	{
		...
		public static bool FindClickWorldIntersection(Vector2 screenPos, out GameObject foundObject)
		{
			...
			if (_prevSceenPos != screenPos)
			{
				...
				if (FindMultiWorldIntersection(rayStart, rayEnd, out _deepClickIntersections, ignoreInvisibleSurfaces: !wireframeShown, ignoreUnrenderables: !wireframeShown))
				{					
					var visibleLayers = Tools.visibleLayers;
		...
		public static bool FindUnityWorldIntersection(Vector2 screenPos, out GameObject foundObject)
		{
			...
			if (FindMultiWorldIntersection(rayStart, rayEnd, out intersections, ignoreInvisibleSurfaces: !wireframeShown))
			{
				var visibleLayers = Tools.visibleLayers;
		...
		public static bool FindMultiWorldIntersection(Vector3 rayStart, Vector3 rayEnd, out BrushIntersection[] intersections, bool ignoreInvisibleSurfaces = true, bool ignoreUnrenderables = true, CSGBrush[] ignoreBrushes = null)
		{
			intersections = null;
			if (InternalCSGModelManager.External == null ||
